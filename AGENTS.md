...
Record completed local changes as prepared for the next app update until actual
release is verified. Keep stable note IDs when updating release status so email
sharing history survives. Include the notes in the website push when pushing

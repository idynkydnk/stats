...
Describe the changes directly without release-status prefaces. Do not add
"prepared for the next app update" to descriptions. Publish these notes with the website. An app-only
